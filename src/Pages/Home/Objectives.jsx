...
const Objectives = () => {
    return (
        <div className="flex flex-col justify-center items-center">
            <p className="text-3xl lg:text-4xl font-bold">Our <span className="text-greenColor">Objectives</span></p>
            <div className="flex flex-row px-2 py-8 gap-6 flex-wrap items-center justify-center">
                {ObjectArray.map((objective, index) => (
                    <div key={index} className="flex flex-col p-4 justify-center items-center h-72 w-10/12 sm:w-72 gap-6 shadow-lg">
